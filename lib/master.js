...
module.exports = inherit([CronRunner, Logger], {
    ...
    __constructor: function (options) {
        ...
        if (!this._options['yandex-disk']) {
            ...
            this._sendTask = new SendSimple(this._options);
            this._symlinkTask = new SymlinkSimple(this._options);
        } else {
            this._sendTask = new SendDisk(this._options);
        ...
        return this.buildTarget()
            .then(function (buildResult) {
                ...
                return vow.resolve({ buildResult: buildResult, snapshotName: name })
                    ...
                    .then(this._sendTask.execute.bind(this)) // Optionally sends it to Yandex Disk
                    .then(this._symlinkTask.execute.bind(this)) // Switches all configured symlinks to this snapshot
                    .then(this._sendChangesTask.execute.bind(this)); // Sends snapshot data changes via e-mail
            }, this);
    },
